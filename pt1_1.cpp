#include "helper.h" // includes the helper header file

	// Add Implementation to the Helper Functions
	
	int addition(int x, int y) // when calling this function, we require the developer to put two INTEGERS.
	{
